...
public func greaterThanOrEqual<Axis, Anchor>(_ keyPath: KeyPath<UIView, Anchor>,
...
public func greaterThanOrEqual<Axis, Anchor>(_ keyPath: KeyPath<UIView, Anchor>,
											 ...
											 constant: CGFloat = 0,
											 priority: UILayoutPriority = .required) -> Constraint where Anchor: NSLayoutAnchor<Axis> {
	return greaterThanOrEqual(keyPath, to: view, keyPath, constant: constant, priority: priority)
}
...
///   - priority: приоритет
/// - Returns: функция Constraint
public func greaterThanOrEqualTo<Dimension>(_ keyPath: KeyPath<UIView, Dimension>,
											constant: CGFloat = 0,
											priority: UILayoutPriority = .required) -> Constraint where Dimension: NSLayoutDimension {
	return { child, _ in
		child[keyPath: keyPath].constraint(greaterThanOrEqualToConstant: constant)
		.with(priority: priority)
	}
}
...
public func greaterThanOrEqualTo<Dimension>(_ keyPath: KeyPath<UIView, Dimension>,
											...
											priority: UILayoutPriority = .required) -> Constraint where Dimension: NSLayoutDimension {
	return { child, parent in
		child[keyPath: keyPath].constraint(greaterThanOrEqualTo: parent[keyPath: to],
...
public func greaterThanOrEqualTo<Dimension>(_ keyPath: KeyPath<UIView, Dimension>,
											...
											constant: CGFloat = 0,
											priority: UILayoutPriority = .required) -> Constraint where Dimension: NSLayoutDimension {
	return greaterThanOrEqualTo(keyPath, keyPath, multiplier: multiplier, constant: constant, priority: priority)
}
...
public func greaterThanOrEqualTo<Dimension>(_ keyPath: KeyPath<UIView, Dimension>,
											...
											priority: UILayoutPriority = .required) -> Constraint where Dimension: NSLayoutDimension {
	return { child, _ in
		child[keyPath: keyPath].constraint(greaterThanOrEqualTo: view[keyPath: to],
										   multiplier: multiplier,
										   constant: constant)
		.with(priority: priority)
	}
...
public func greaterThanOrEqualTo<Dimension>(_ keyPath: KeyPath<UIView, Dimension>,
											...
											constant: CGFloat = 0,
											priority: UILayoutPriority = .required) -> Constraint where Dimension: NSLayoutDimension {
	return greaterThanOrEqualTo(keyPath, to: view, keyPath, multiplier: multiplier, constant: constant, priority: priority)
}
